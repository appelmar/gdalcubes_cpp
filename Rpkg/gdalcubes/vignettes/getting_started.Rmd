...
```
# TODO: Join CHIRPS precipitation data


# TODO: fit a model like NDVI ~ temp last month or last month diff DAY-NIGHT or CHIRS



```{r}

gcbs_create_image_collection(list.files("CHIRPS_MONTHLY", "*.tif", full.names = TRUE), "CHIRPS_v2_0_monthly_p05_tif", "CHIRPS_MONTHLY.db")

plot(gcbs_cube(gcbs_image_collection("CHIRPS_MONTHLY.db")), key.pos=1, t=1)
