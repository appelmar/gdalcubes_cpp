...
class default_chunking : public chunking {
   public:
    ...
    bounds_st bounds_from_chunk(chunkid id) {
        ...
        // Shrink to view
        if (out_vcoords_high[0] < 0) out_vcoords_high[0] = 0;
        else if (out_vcoords_high[0] > _v.nt()) out_vcoords_high[0] = _v.nt();
        if (out_vcoords_low[0] < 0) out_vcoords_low[0] = 0;
        else if (out_vcoords_low[0] > _v.nt()) out_vcoords_low[0] = _v.nt();

        if (out_vcoords_high[1] < 0) out_vcoords_high[1] = 0;
        else if (out_vcoords_high[1] > _v.ny()) out_vcoords_high[1] = _v.ny();
        if (out_vcoords_low[1] < 0) out_vcoords_low[1] = 0;
        else if (out_vcoords_low[1] > _v.ny()) out_vcoords_low[1] = _v.ny();

        if (out_vcoords_high[2] < 0) out_vcoords_high[2] = 0;
        else if (out_vcoords_high[2] > _v.nx()) out_vcoords_high[2] = _v.nx();
        if (out_vcoords_low[2] < 0) out_vcoords_low[2] = 0;
        else if (out_vcoords_low[2] > _v.nx()) out_vcoords_low[2] = _v.nx();
