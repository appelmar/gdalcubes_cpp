...
class image_collection_ops {
   public:
    static void translate_gtiff(std::shared_ptr<gdalcubes::image_collection> in, std::string out_dir, uint16_t nthreads = 1, bool force = true, std::vector<std::string> creation_options = {});
