...
struct reducer_singleband {
     ...
     */
    virtual void init(std::shared_ptr<chunk_data> a, uint16_t band_idx_in, uint16_t band_idx_out) = 0;
...
struct sum_reducer_singleband : public reducer_singleband {
    void init(std::shared_ptr<chunk_data> a, uint16_t band_idx_in, uint16_t band_idx_out) override {
